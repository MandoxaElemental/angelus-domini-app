...
export default function PrayerScreen() {
  ...
  useEffect(() => {
    fadeAnim.setValue(0);
    Animated.timing(fadeAnim, {
      toValue: 1, duration: 1200, easing: Easing.out(Easing.ease), useNativeDriver: false,
    }).start();
  }, [currentStep]);
          ...
          <View style={styles.bellContainer}>
            ...
            <Animated.Image
              ...
              style={[styles.bellImage, {
                transform: [{ rotate: bellRotate.interpolate({ inputRange: [-1, 1], outputRange: ["-12deg", "12deg"] }) }],
              }]}
            />
          </View>
        </View>
      ...
      <Modal visible={showCompletionModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalText}>You have completed the Angelus for this hour.</Text>
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  card:               { margin: 24, padding: 24, backgroundColor: "#FFFAF2", borderRadius: 24, maxHeight: 260, minHeight: 260, justifyContent: "center", shadowColor: "#4a392f", shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.1, shadowRadius: 15, elevation: 10 },

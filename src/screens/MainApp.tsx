...
// ── Carousel slots definition (stable reference outside component) ──────────
...
export default function MainApp() {
  ...
  // Auto-cycle carousel every 3 seconds with fade transition
  useEffect(() => {
    const id = setInterval(() => {
      // Fade out
  ...
  // Current carousel slot data (derived, not state)
          ...
          <View style={styles.globalCard}>
            ...
            <View style={[styles.globalRight]}>
              <View>
                ...
                {/* ── CAROUSEL: cycles Morning → Noon → Evening every 3 s ── */}
                <Animated.View
                  style={[styles.globalCountRow, { opacity: carouselAnim }]}
                >
                  <Text style={styles.hourCount}>
                    {activeCarouselCount.toLocaleString()}
                  </Text>

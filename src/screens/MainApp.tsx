...
const styles = StyleSheet.create({
  ...
  greetingTitle:      { fontSize: 24, color: COLORS.textPrimary, fontWeight: "600", fontFamily: "Cormorant", marginTop: -22, },
  greetingSubtitle:   { fontSize: 20, color: COLORS.navy, fontFamily: "Cormorant" },
  mainCard:           { minHeight: 154, marginHorizontal: 24, marginTop: -10, backgroundColor: COLORS.card, borderRadius: 28, borderWidth: 1, borderColor: COLORS.border, padding: 2, flexDirection: "row", shadowColor: "#3B2E22", shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 6 },
  ...
  sectionHeader:      { flexDirection: "row", alignItems: "center", marginHorizontal: 16, marginTop: 5, marginBottom: 10 },
  ...
  progressImage:      { width: 68, height: 68 },
   progressImages:      { width: 50, height: 68, marginTop: -23 },
  globalCard:         { marginHorizontal: 24, marginTop: 5, backgroundColor: COLORS.card, borderRadius: 28, borderWidth: 1, borderColor: COLORS.border, padding: 5, flexDirection: "row", alignItems: "flex-start", shadowColor: "#3B2E22", shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 6 },
  ...
  globalPrayedToday:  { fontSize: 13, lineHeight: 15, color: COLORS.textSecondary, fontFamily: "Cormorant" },
  globalText:         { color: COLORS.textSecondary, fontSize: 12, fontFamily: "Cormorant", marginTop: 5,   lineHeight: 15  },
  ...
  carouselDots:       { flexDirection: "row", justifyContent: "center", alignItems: "center", marginTop: 6, marginBottom: 2 },
